...
namespace Csvier.Test
{
    ...
    public class ClimaTest
    {
        ...
        {
            const string sampleWeather = "#The CSV format is in following way:-\n" +
            ...
            CsvParser pastWeather = new CsvParser(typeof(WeatherInfo)).Load(sampleWeather);
            
            pastWeather.RemoveWith("#");
            Assert.AreEqual("", 
                pastWeather.getArr()[0]);
            ...
            Assert.AreEqual("2019-01-02,24,18,64,6,9,179,S,116,http://cdn.worldweatheronline.net/images/wsymbols01_png_64/wsymbol_0002_sunny_intervals.png,Partly cloudy,0.0,57,10,1030,15,14,57,6,42,13,56,11,17,13,56", 
                pastWeather.getArr()[1]);

            pastWeather.RemoveOddIndexes();
            Assert.AreEqual("2019-01-03,24,16,60,7,11,89,E,113,http://cdn.worldweatheronline.net/images/wsymbols01_png_64/wsymbol_0001_sunny.png,Sunny,0.0,67,10,1026,3,13,55,7,45,12,54,11,18,12,54", 
                pastWeather.getArr()[1]);
            
//            foreach (string s in pastWeather.getArr())
//            {
//                Console.WriteLine(s);
//            }
        }
