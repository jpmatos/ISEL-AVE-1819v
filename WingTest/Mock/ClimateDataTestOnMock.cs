...
{
    [TestFixture]
    public class ClimateDataTestOnMock
    {
        [Test]
        public void TestLoadYearlyAverageInPortugalOnMock()
        {
            ...
            mocker
                ...
                .With(1980, 1999, "PRT")
                .Return(new TemperatureYearInfo[]
                {
        ...
        [Test]
        public void TestLoadYearlyAverageInPortugalOnRequestMock()
        {
            Mocker mocker = new Mocker(typeof(IHttpRequest));
            mocker
                .When("GetBody")
                .With("http://climatedataapi.worldbank.org/climateweb/rest/v1/country/annualavg/tas/1980/1999/PRT.csv")
                .Return(
